...
| **Day 12** | **Day 11 議論で確定するメイン候補** (Day 11 評価 Section 12.31 / 12.32 / 2.21 から導出): 🟡 02-data-provenance §4.4 RetiredEntity (Day 12 メイン候補に格上げ、退役 entity の構造的検出 + Lean linter / elaborator) ほか副候補は Day 11 完了後の議論 (Section 2.22 で確定予定) | Section 2.21 (Day 11 評価) + Section 12.31-12.33 + 02-data-provenance §4.4 |
