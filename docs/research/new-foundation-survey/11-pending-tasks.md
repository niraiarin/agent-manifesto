...
| 🟡 Day 22 | **A-Standard-Full-Standard: PersistentEnvExtension callback** (declaration 追加時 auto-trigger、Day 21 hardcode list を env-driven 拡張) | TyDD-G3 | Day 22 メイン候補 |
| 🟡 Day 22+ | **Role.toCtorIdx auto-gen helper root cause 投資** (Day 20-21 Subagent I2/I4 継続) | Day 20-21 Subagent | Day 22+ |
...
| **Day 22** | Day 21 議論で確定 Q1-Q4 (Section 2.42): 🟡 A-Standard-Full-Standard PersistentEnvExtension callback (Day 21 hardcode list を env-driven 拡張) | Section 2.41 + Section 12.61-12.63 + Day 21 Subagent I4 |
