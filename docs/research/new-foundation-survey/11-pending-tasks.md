...
| **Day 19** | **Day 18 議論で確定するメイン候補** (Day 18 評価 Section 12.52-12.54 / 2.35 から導出): 🟡 A-Standard-Lite namespace 検出拡張 (`#check_retired_in_namespace NS` で NS 配下 RetiredEntity 全検出、Day 18 A-Minimal の自然な拡張) ほか副候補 (Day 15×Day 18 連携テスト / ResearchActivity payload / A-Standard-Full) は Day 18 完了後の議論 (Section 2.36 で確定予定) | Section 2.35 (Day 18 評価) + Section 12.52-12.54 + TyDD-G3 A-Standard-Lite |
