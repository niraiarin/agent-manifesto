...
| 🟡 Day 21 | **A-Standard-Full: elaborator hook** (command 実行時自動 linting、Day 18-19-20 段階的 Lean 機能習得の自然な続き) | TyDD-G3 | Day 21 メイン候補 |
| 🟡 Day 21+ | **Role.toCtorIdx auto-gen helper 顕在化の root cause 投資** (Day 20 Subagent I2、Lean 4 deprecated marker 伝播メカニズム解明) | Day 20 Subagent I2 | Day 21+ |
...
| **Day 21** | Day 20 議論で推奨案仮確定 Q1-Q4 (Section 2.40): 🟡 A-Standard-Full elaborator hook (Day 18-19-20 段階的拡張の自然な続き、Week 5-6 A-Maximal pre-stage) ほか副候補 (Role.toCtorIdx investigation / 連携テスト / payload) は Section 2.40 で確定予定 | Section 2.39 + Section 12.58-12.60 + Day 20 Subagent I2/I3 |
