...
| 🔴 Day 26-27 | **ResearchActivity payload 拡充** (Day 13-22 から **12 Day 連続繰り延べ**、Day 24 audit で次の long-deferred candidate 警告識別、Day 26+ で必ず解消) | Day 24 audit 次 long-deferred | Day 26-27 主 scope 候補 |
...
**主要決定**: 確認次第 Day 26 着手。Day 25 D15 observe-first 方針で Day 26 は dedup 判断も可能だが、ResearchActivity payload の 12 Day 連続繰り延げが優先 (Day 22 audit 教訓の long-deferred 化防止に従う)。dedup 判断は Day 27+ で継続。
