...
| **Day 14** | **Day 13 議論で確定するメイン候補** (Day 13 評価 Section 12.37 / 12.38 / 2.25 から導出): 🟡 RetiredEntity linter / elaborator (新分野、Day 12-13 で structural detection + relation 完備、linter は自然な次 step、Day 12 から繰り延べ) ほか副候補は Day 13 完了後の議論 (Section 2.26 で確定予定) | Section 2.25 (Day 13 評価) + Section 12.37-12.39 + 02-data-provenance §4.4 |
