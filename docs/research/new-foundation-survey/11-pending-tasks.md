...
| **Day 13** | **Day 12 議論で確定するメイン候補** (Day 12 評価 Section 12.34 / 12.35 / 2.23 から導出): 🟡 PROV-O auxiliary relations (WasInformedBy / ActedOnBehalfOf) + WasRetiredBy (relation 系 grouping、Day 12 で開いたパス、Day 11 ProvRelation パターン踏襲) ほか副候補は Day 12 完了後の議論 (Section 2.24 で確定予定) | Section 2.23 (Day 12 評価) + Section 12.34-12.36 + 02-data-provenance §4.1 + §4.4 |
