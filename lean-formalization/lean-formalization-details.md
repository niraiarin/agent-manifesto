...
Pareto 改善の不可能性は含意しない。これは constraints-taxonomy.md の
「潜在的な副作用」という記述に忠実。
...
#### 20. ReviewSignal — constraints-taxonomy.md Part IV の型化

**問題:** constraints-taxonomy.md の見直しシグナル5種をどう形式化するか。
...
**問題:** constraints-taxonomy.md Part II の核心構造「境界条件は動かない。緩和策は設計判断。変数は緩和策の効き具合」が型として表現されていなかった。
...
- constraints-taxonomy.md（制約・境界条件・変数の体系的整理）
...
### 2. constraints-taxonomy.md との整合性
