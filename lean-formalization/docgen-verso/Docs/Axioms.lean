/-
Agent Manifesto - Axioms: Base Theory T0
...
#doc (Manual) "Axioms: Base Theory T0" =>
...
*Declaration:* `opaque structureImproved`
...
*
  ...
  * opaque — Phase 3+ で遷移条件を定義
*
  * `Ontology.lean: globalResourceBound`
  * opaque — Phase 2+ でドメインに応じて具体化
*
  * `Axioms.lean: structureImproved`
  * opaque — Phase 4+ で Observable として定義
:::
