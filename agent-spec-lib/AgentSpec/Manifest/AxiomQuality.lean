...
namespace AgentSpec.Manifest.AxiomQuality
...
theorem full_coverage_example :
  coveragePercent 62 62 = 100 := by rfl
...
def currentQuality : QualityProfile :=
  { compressionRatio := compressionRatio currentProfile  -- 457 (= 4.57x)
...
end AgentSpec.Manifest.AxiomQuality
