...
-- Day 161: `context_finite` は AgentSpec.Manifest.Ontology / D.lean に pre-pick 済み。重複削除。
...
-- Day 161: `structureImproved` は AgentSpec.Manifest.Ontology / D.lean に pre-pick 済み。重複削除。

-- Day 161: `processImproved` は AgentSpec.Manifest.Ontology / D.lean に pre-pick 済み。重複削除。
...
-- Day 161: `isHuman` は AgentSpec.Manifest.Ontology / D.lean に pre-pick 済み。重複削除。
