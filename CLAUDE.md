...
- `lean-formalization/` — Lean 4 形式検証（61 axioms, 210 theorems, 0 sorry）
...
- `bash tests/test-all.sh` — run all 140 acceptance tests (Phase 1–5)
...
- Current stats: 61 axioms, 210 theorems, 0 sorry
