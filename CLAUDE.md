...
- `lean-formalization/` — Lean 4 形式検証（63 axioms, 261 theorems, 0 sorry）
...
- `bash tests/test-all.sh` — run all 199 acceptance tests (Phase 1–5)
...
- Current stats: 63 axioms, 261 theorems, 0 sorry
