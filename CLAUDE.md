...
- `lean-formalization/` — Lean 4 形式検証（63 axioms, 353 theorems, 0 sorry）
...
- `bash tests/test-all.sh` — run all 290 acceptance tests (Phase 1–5)
...
- Current stats: 63 axioms, 353 theorems, 0 sorry
