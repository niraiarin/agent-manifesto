...
- `lean-formalization/` — Lean 4 形式検証（61 axioms, 221 theorems, 0 sorry）
...
- `bash tests/test-all.sh` — run all 159 acceptance tests (Phase 1–5)
...
- Current stats: 61 axioms, 221 theorems, 0 sorry
