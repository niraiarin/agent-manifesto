...
- `lean-formalization/` — Lean 4 形式検証（63 axioms, 269 theorems, 0 sorry）
...
- `bash tests/test-all.sh` — run all 215 acceptance tests (Phase 1–5)
...
- Current stats: 63 axioms, 269 theorems, 0 sorry
