...
- `lean-formalization/` — Lean 4 形式検証（51 axioms, 407 theorems, 0 sorry）
...
- `bash tests/test-all.sh` — run all 530 acceptance tests (Phase 1–5)
...
- Current stats: 51 axioms, 407 theorems, 0 sorry
